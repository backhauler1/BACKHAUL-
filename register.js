...
const registerSchema = z.object({
    ...
    privacyPolicy: z.any().optional() // Passed through so requireConsent can validate it
});
 ...
 */
router.post('/register', authLimiter, requireConsent, validate({ body: registerSchema }), async (req, res) => {
    ...
    try {
        ...
        const newUserQuery = await pool.query(
            ...
            [name, email, hashedPassword, ['user'], newReferralCode, referredById, req.consentLog]
        );

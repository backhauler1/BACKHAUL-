...
describe('Loads API - Interaction Endpoints', () => {
    ...
    describe('PATCH /:id/accept', () => {
        ...
        it('should return 409 if the driver already has an active load', async () => {
            // This logic was moved to the /accept-bid endpoint. The /accept route now just checks if the load is available.
            // We'll test the "no longer available" case instead.

...
export async function initializeCompaniesAdminPage() {
    ...
    if (searchForm && !searchForm.dataset.initialized) {
        searchForm.addEventListener('submit', async (e) => {
            ...
            await loadCompaniesDashboard(1, currentSearchTerm);
        });
        searchForm.dataset.initialized = 'true';
    }

    if (tbody && !tbody.dataset.initialized) {

...
describe('Stripe Webhook Event Handling', () => {
    ...
    it('should process payment_intent.succeeded and issue a referral reward if it is their first order', async () => {
        ...
        expect(mockStripeInstance.coupons.create).toHaveBeenCalledWith(expect.objectContaining({ amount_off: 5000 }));
        expect(mockStripeInstance.promotionCodes.create).toHaveBeenCalledWith({ coupon: 'COUPON_123', max_redemptions: 1, restrictions: { minimum_amount: 50000, minimum_amount_currency: 'usd' } });
        ...
        expect(rewardEmailArgs.subject).toBe('You earned a $50 Referral Reward!');

            ...
            if (loc.type === 'load') {
                ...
                popupHTML = `
                    <div class="truck-popup" style="color: #333;">
                        ...
                        <p style="margin: 0 0 5px 0; font-size: 0.85em; color: #666;"><strong>Requires:</strong> ${loc.requiredVehicleClass || 'Any Vehicle'}</p>
                        <p style="margin: 0 0 5px 0; font-size: 0.85em; color: #666;"><strong>Destination:</strong> ${loc.destination || 'Not specified'}</p>

...
describe('Trucks API', () => {
    beforeEach(() => {
        ...
        mockNone.mockImplementation(() => (req, res, next) => next());
    });
    ...
    describe('POST /register', () => {
        it('should successfully register a truck with a thumbnail', async () => {
            ...
            const res = await request(app)
                ...
                .field('truckName', 'My Big Rig')
                .field('truckType', 'dry_van')
                .field('homeBase', 'Los Angeles, CA');
            ...
            expect(pool.query).toHaveBeenCalledWith(
                ...
                expect.arrayContaining(['My Big Rig', 'dry_van', 'Los Angeles, CA', mockNewTruck.thumbnail_url, 1, -118.2437, 34.0522])
            );
        });
    });

    describe('GET /me', () => {
        it('should return a list of trucks owned by the current user', async () => {
            const mockTrucks = [
            ...
            const res = await request(app).get('/api/trucks/me');

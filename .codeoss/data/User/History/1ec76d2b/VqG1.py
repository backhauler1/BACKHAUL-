...
def init_db():
    ...
    # Safely attempt to add columns for shipper digital acknowledgment
    try:
        cursor.execute("ALTER TABLE loads ADD COLUMN shipper_acknowledged INTEGER DEFAULT 0")
        cursor.execute("ALTER TABLE loads ADD COLUMN shipper_acknowledgment_timestamp REAL")
    except sqlite3.OperationalError:
        pass

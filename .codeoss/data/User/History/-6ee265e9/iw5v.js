                        ...
                        if (referredById) {
                            ...
                            if (orderCount === 1) { // It's their first successful order!
                                ...
                                const coupon = await stripe.coupons.create({
                                    amount_off: 5000, // $50.00 off
                                    currency: 'usd',
                                    duration: 'once',
                                    name: 'Referral Reward - $50 Off (Min $500 Spend)',
                                });
                                ...
                                const promoCode = await stripe.promotionCodes.create({
                                    ...
                                    restrictions: {
                                        minimum_amount: 50000, // Require a $500 minimum cart value
                                ...
                                if (referrer) {
                                    const emailOptions = {
                                        to: referrer.email,
                                        subject: 'You earned a $50 Referral Reward!',
                                        text: `Hi ${referrer.name},\n\nSomeone you referred just completed their first order! As a thank you, here is a $50 promo code for your next order of $500 or more: ${promoCode.code}\n\nBest,\nYour App Team`,
                                        html: `<div style="font-family: sans-serif; line-height: 1.6;"><h2>You earned a $50 Reward!</h2><p>Hi ${referrer.name},</p><p>Someone you referred just completed their first order!</p><p>As a thank you, here is a $50 promo code for your next order of $500 or more:</p><h3 style="background-color: #f4f4f4; padding: 10px; display: inline-block; border-radius: 5px;">${promoCode.code}</h3><br><p>Best,</p><p><strong>Your App Team</strong></p></div>`
                                    };
                                    await sendEmail(emailOptions);

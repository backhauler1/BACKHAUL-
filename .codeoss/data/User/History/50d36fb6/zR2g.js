...
function _createResultItemElement(truck) {
    ...
    // NOTE: This assumes your API response includes `name`, `description`, and optionally `thumbnailUrl`.
    ...
    // If a truck is unavailable, add a class for styling and status text.

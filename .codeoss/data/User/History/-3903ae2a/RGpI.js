...
router.post('/reset-password', authLimiter, async (req, res) => {
    ...
    try {
        ...
        await pool.query(
            `UPDATE users 
             SET password = $1, reset_password_token = NULL, reset_password_expires = NULL, refresh_token = NULL 
             WHERE id = $2`,
...
router.post('/change-password', protect, authLimiter, async (req, res) => {
    ...
    try {
        ...
        await pool.query('UPDATE users SET password = $1, refresh_token = NULL WHERE id = $2', [hashedNewPassword, userId]);

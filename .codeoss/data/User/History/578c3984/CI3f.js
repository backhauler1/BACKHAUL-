...
async function loadMyTrucks(container, page = 1) {
    ...
    try {
        ...
        trucks.forEach(truck => {
            ...
            const thumbnail = truck.thumbnail_url || '/home/perrymckay1/images/Color logo - no background.png'; 
            const thumbnail = truck.thumbnail_url || '/images/Color logo - no background.png'; 

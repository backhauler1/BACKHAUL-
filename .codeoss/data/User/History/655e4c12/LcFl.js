...
/**
 * Wires up the DOM elements for Passkey Registration.
 * @param {HTMLElement} buttonElement 
 */
export function setupPasskeyRegistrationBtn(buttonElement) {
    if (!buttonElement) return;
    buttonElement.addEventListener('click', async () => {
        const originalText = buttonElement.textContent;
        buttonElement.disabled = true;
        buttonElement.textContent = 'Awaiting Device Prompt...';
...
/**
 * Wires up the DOM elements for Passkey Login.
 * @param {HTMLElement} buttonElement 
 * @param {HTMLInputElement} inputElement 
 */
export function setupPasskeyLoginBtn(buttonElement, inputElement) {
    if (!buttonElement) return;
    buttonElement.addEventListener('click', async () => {

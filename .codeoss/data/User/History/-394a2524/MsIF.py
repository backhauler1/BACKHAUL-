...
def accept_bid(bid_id):
    ...
    cursor.execute("""
        SELECT b.id, b.load_id, b.driver_id, l.user_id as shipper_id, l.status as load_status
        FROM bids b
    ...
    try:
        ...
        # TODO: You could add a notification system here to inform the driver.
        # e.g., send_notification(driver_id, f"Your offer for load {load_id} was accepted!")
...
def decline_bid(bid_id):
    ...
    cursor.execute("""
        SELECT b.id, b.load_id, b.driver_id, l.user_id as shipper_id
        FROM bids b
        JOIN loads l ON b.load_id = l.load_id
        WHERE b.id = ?
    """, (bid_id,))
    ...
    try:
        ...
        # TODO: You could add a notification system here to inform the driver.
        # e.g., send_notification(bid_info['driver_id'], f"Your offer for load {bid_info['load_id']} was declined.")

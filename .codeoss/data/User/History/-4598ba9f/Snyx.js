...
describe('Language Selector UI (languageSelector.js)', () => {
    ...
    it('should change language, update the backend, show notification, and reload for logged-in users', async () => {
        ...
        await new Promise(process.nextTick); // Wait for async logic

        // Wait for all async operations in the event handler to complete
        // This is more robust than waiting for a single process tick.
        ...
        // Advance the timers by 1 second to trigger the page reload timeout

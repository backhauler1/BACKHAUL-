...
describe('Password Forms Validation (passwordForms.js)', () => {
    ...
    beforeEach(() => {
        ...
        window.location = { ...originalLocation, href: 'http://localhost/?token=mock_token_123&email=test@example.com', search: '?token=mock_token_123&email=test@example.com', assign: jest.fn(), reload: jest.fn() };

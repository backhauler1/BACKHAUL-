...
describe('Password Forms Validation (passwordForms.js)', () => {
    beforeEach(() => {
        ...
        let currentHref = 'http://localhost/?token=mock_token_123&email=test@example.com';
        ...
        let currentSearch = '?token=mock_token_123&email=test@example.com';
        Object.defineProperty(window.location, 'search', {
            configurable: true,
            get: () => currentSearch,
            set: (url) => { currentSearch = url; }
        });

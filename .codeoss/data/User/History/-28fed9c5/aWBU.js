        ...
        if (pickup && delivery && estimateDisplay) {
            ...
            try {
                ...
                if (response && response.suggested_rate) {
                    estimateDisplay.innerHTML = `<span style="color: #28a745; font-weight: 500;">Suggested Rate: $${response.estimated_rate_min} - $${response.estimated_rate_max}</span> <span style="font-size: 0.85em;">(${response.distance_miles} miles)</span>`;
                }
            } catch (error) {

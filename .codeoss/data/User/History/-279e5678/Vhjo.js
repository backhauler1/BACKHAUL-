...
export async function initializeMyPostedLoadsPage(containerId = 'my-posted-loads-container') {
    ...
    if (!document.getElementById('my-posted-loads-sort-container')) {
        const sortContainer = document.createElement('div');
        sortContainer.id = 'my-posted-loads-sort-container';
...
async function loadPostedLoads(container, page = 1) {
    ...
    try {
        const response = await apiFetch(`/api/loads/posted?page=${page}&limit=12&sortBy=${sortBy}&sortOrder=${sortOrder}`);

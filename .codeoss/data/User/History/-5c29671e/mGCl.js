...
describe('chat.js', () => {
    ...
    describe('initializeChatPage', () => {
        it('should do nothing if the required chat elements are not found in the DOM', () => {
            ...
            initializeChatPage(mockSocket);
            expect(mockSocket.on).not.toHaveBeenCalled();
        });

        it('should log an error and exit if the socket instance is not provided', () => {
            ...
            // Call without a socket instance
            initializeChatPage(null);

            expect(consoleErrorSpy).toHaveBeenCalledWith('Socket instance not provided to chat page.');

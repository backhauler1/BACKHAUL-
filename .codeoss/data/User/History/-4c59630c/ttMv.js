...
function showPrivacyModal() {
    ...
    modal.style.cssText = 'background: #fff; width: 90%; max-width: 800px; height: 80vh; max-height: 600px; border-radius: 8px; box-shadow: 0 10px 25px rgba(0,0,0,0.3); display: flex; flex-direction: column; overflow: hidden; position: relative; font-family: sans-serif;';
    
    const header = document.createElement('div');
    header.style.cssText = 'padding: 15px 20px; border-bottom: 1px solid #e0e0e0; display: flex; justify-content: space-between; align-items: center; background: #f8f9fa; color: #333;';
    header.innerHTML = '<h3 style="margin: 0; font-size: 1.2em;">Privacy Policy</h3><button id="close-privacy-modal" style="background: none; border: none; font-size: 1.5em; cursor: pointer; color: #666; line-height: 1; padding: 0;">&times;</button>';
    ...
    footer.style.cssText = 'padding: 15px 20px; border-top: 1px solid #e0e0e0; display: flex; justify-content: flex-end; background: #f8f9fa;';

...
function showCookieBanner() {
    ...
    banner.innerHTML = `
        <div style="display: flex; align-items: center; gap: 15px; flex: 1; min-width: 250px;">
            <!-- Add your logo here -->
            <img src="" alt="Company Logo" style="height: 40px; width: auto; flex-shrink: 0;">
            <img src="/path/to/your/logo.png" alt="Company Logo" style="height: 40px; width: auto; flex-shrink: 0;">
...
function showPrivacyModal() {
    ...
    header.innerHTML = `
        <div style="display: flex; align-items: center; gap: 10px;">
            <!-- Add your logo here -->
            <img src="/img/logo-light.svg" alt="Company Logo" style="height: 24px;">
            <img src="/path/to/your/logo.png" alt="Company Logo" style="height: 24px;">
            <h3 style="margin: 0; font-size: 1.2em;">Privacy Policy</h3>
        </div>
        <button id="close-privacy-modal" style="background: none; border: none; font-size: 1.5em; cursor: pointer; color: #cbb26a; line-height: 1; padding: 0;">&times;</button>`;

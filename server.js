...
// --- Health Check Route ---
// This should be before CSRF validation as it's often called by automated systems.
...
// Add Redis adapter for horizontal scaling (skip in test environment)
...
async function startServer() {
    try {
        ...
        logger.error('Failed to start server due to migration error:', err);
        process.exit(1);
    }
}
